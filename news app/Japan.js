...
async function getData(){
    const res = await fetch('https://newsapi.org/v2/top-headlines?country=jp&apiKey=65a59df3391248a59d09daff1c7fa763' );
         ...
         article.innerHTML = `
             ...
             <div class="article-content">
                 <a class="aa" href="${data[i].url}" target="_blank">
                        <h2 class="heading1" id="heading-${i}">${data[i].title}</h2>
                    </a>
